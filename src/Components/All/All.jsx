        ...
        <>
            <div className="container mt-3">
                <div className="row">
                                        ...
                                        <div className="">
                                            <div className="d-flex justify-content-between p-2">
                                                ...
                                                <div className="d-flex mb-n2 justify-content-between align-items-center">
                                                    ...
                                                    {game.platform === "PC (Windows)" ? <i className="fab fa-windows me-1"></i> : <i className="fas fa-window-maximize me-1" title="Available on Browser"></i>}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    ) : (<div className="spinner"> <img width="100px" src={spinner} alt="" /> </div>)}
                </div>
